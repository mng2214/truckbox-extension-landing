...
export type Win = { emailsSent: number; emailsAuto: number; mapsOpened: number; callsPlaced: number };
      ...
      {stats.dispatchers.length > 0 && (
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard label="Sent automatically" value={String(grand.emailsAuto)} />
            ...
            <table className="w-full text-sm" style={{ minWidth: "26rem" }}>
              <thead>
                <tr style={{ color: "var(--muted)" }}>
                  ...
                  <th className="text-right font-normal py-1">Auto</th>
              ...
              <tbody>
                {(
                  ...
                  <tr key={label} style={{ borderTop: "1px solid var(--hairline)" }}>
                    ...
                    <td className="text-right py-1" style={{ color: "var(--muted)" }}>{w.emailsAuto}</td>
